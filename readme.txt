...
|  readPreference | object <br /> ```{readPreference: secondary}```  <br />  ```{readPreference: '{mode: "secondary", tagSets:[ { "region": "east" } ], maxStalenessSeconds: 120}'}```| primary  |  Specifies the read preference for mongodump |
